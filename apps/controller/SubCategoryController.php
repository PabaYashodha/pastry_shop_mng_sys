...
switch ($status) {
    ...
    case 'getSubCategoryName':
        $searchKey = $_REQUEST['subCategory'];
        $getSubCategoryName = $subCategoryObj->getSubCategoryName($searchKey);
        $searchResult[] = "";
        while ($row = $getSubCategoryName->fetch_assoc()) {
            $searchResult[] = array(
