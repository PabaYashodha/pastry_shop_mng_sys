...
<body>
    <nav class="navbar navbar-inverse navbar-expand-md navbar-dark fixed-top py-0">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    <a class="nav-link" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
                        <img src="../../images/user-images/1653931508.jpg" width="35px" height="35px" alt="profile-pic" class="rounded" id="userProfileImage">
                    </a>
            ...
            <?php echo $_SESSION["user"]["user_fname"];?>  <?php echo $_SESSION["user"]["user_lname"] ?> <br>
            <span style="font-size: 12px;" id="logRoleName"></span>
            </span>
        </div>
    </nav>
