        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <button class="btn btn-dark float-end" data-bs-toggle="modal" data-bs-target="#addDeliveryPerson" style="background-color: #2f2e41;"><i class="far fa-plus"></i> ADD DELIVERY PERSON</button>
                </div>
            </div>
