        ...
        <div class="card-body">
            <form action="" method="post" role="form" id="makeOrderForm">
                ...
                <thead>
                    ...
                    <tfoot>
                    <tr>
                            <th scope="col" colspan="4" class="text-end">Sub Amount (Rs)</th>
                        ...
                        <tr>
                            <th scope="col" colspan="4" class="text-end">Discount (%)</th>
                        ...
                        <tr>
                            <th scope="col" colspan="4" class="text-end">Net Total (Rs)</th>
                        ...
                        <tr>
                            <th scope="col" colspan="4" class="text-end">Received Amount (Rs)</th>
                        ...
                        <tr>
                            <th scope="col" colspan="4" class="text-end">Balance Amount (Rs)</th>
