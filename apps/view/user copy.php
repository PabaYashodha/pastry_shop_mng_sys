            ...
            <div class="card-body">
                <table class="table  table-hover table-responsive-*" id="dataTable">
                    ...
                    <tr>
                        ...
                        <td><img src='../../images/user-images/<?php echo $row["user_image"]?>' width="40" height="40"></td>
                        <td><?php echo $row["user_fname"]?> <?php echo $row["user_lname"]?></td>
                        <td><?php echo $row["user_email"]?></td>
                        <td><?php echo $row["user_contact"]?></td><td>  
                        <?php if(($row["user_status"])==1){ ?>
                            <button class="btn btn-outline-success rounded shadow" onclick="deactivateUser((<?php echo base64_encode($row['user_id']) ?>))">Active</button>
                        <?php }else{ ?>
                           <button class="btn btn-outline-danger rounded shadow" onclick="activateUser((<?php echo base64_encode($row['user_id']) ?>))">Deactivate</button>
                        <?php }?>
                        </td>
                        <td>
                        <div class="d-inline-flex justify-content-start">
                        <button class="btn  btn-info" data-bs-toggle="modal" data-bs-target="#viewUser" onclick="viewUserDetails('<?php echo base64_encode($row['user_id']) ?>')"><i class="fal fa-eye"></i></button>&nbsp;&nbsp;&nbsp;
